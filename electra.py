...
def train(train_dataloader, validation_dataloader, device):
    ...
    for epoch_i in range(0, epochs):
        ...
        avg_val_accuracy = 0 / len(validation_dataloader)
        print("  Accuracy: {0:.2f}".format(avg_val_accuracy))

        # Calculate the average loss over all of the batches.
        avg_val_loss = 0 / len(validation_dataloader)
...
if __name__ == "__main__":
    ...
    df_train_original = pickle.load(open(pkl_dump_dir + "multi.pkl", "rb"))
    # df_train_original = pickle.load(open(pkl_dump_dir + "df_remove_sentence.pkl", "rb"))
    ...
    input_ids, attention_masks, labels = bert_tokenize(tokenizer, df_train_original)
    ...
    torch.save(model.state_dict(), pkl_dump_dir + 'multi.pth')
